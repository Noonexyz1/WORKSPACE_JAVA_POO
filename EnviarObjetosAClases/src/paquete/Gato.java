...
public class Gato extends Animal{
	...
	//recibiendo un perro
	public void setPerro(Perro pruebaPerro) {
		System.out.println("Mostrando los datos del perro desde Gato:");
		pruebaPerro.imprimeDatos();//Imprime datos del padre
		pruebaPerro.imprimeInformacion();
		pruebaPerro.nombre = "Antes Shadow Pero ahora JOSELO";
		
	}
	public Perro getPerro(Perro pruebaPerro) {
		System.out.println("Mostrando los datos del perro desde Gato:");
		pruebaPerro.imprimeDatos();//Imprime datos del padre
		pruebaPerro.imprimeInformacion();
		pruebaPerro.nombre = "Antes Shadow Pero ahora JOSELO";
